...
class MyFlushFactory implements FlusherFactory<String, Integer> {
	...
	public TableFlusher<String, Integer> create(OutputStream os) throws IOException {
		...
		Serializer<String, Integer> s = null; // Serializer.create(os, ts);
...
class MyTypesSerializer implements TypesSerializer<String, Integer>, TypesDeserializer<String, Integer>  {
	@Override
	public int serializeKey(ObjectOutputStream os, String data) throws IOException {
		os.writeUTF(data);
		return 0;
	}

	@Override
	public int serializeValue(ObjectOutputStream os, Integer data) throws IOException {
		os.writeInt(data);
		return 0;
	}
